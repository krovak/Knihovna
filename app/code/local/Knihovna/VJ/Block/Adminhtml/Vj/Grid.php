...
class Knihovna_VJ_Block_Adminhtml_Vj_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function _prepareCollection()
    {
        ...
        $collection->getSelect()->join(array('jm' => $autori_tabulka), 'jm.entity_id=main_table.autor', array('autor' => 'jmeno'));
        $autori_tabulka1 = Mage::getSingleton('core/resource')->getTableName('autor/knihovna_autor');
        $collection->getSelect()->join(array('pr' => $autori_tabulka1), 'pr.entity_id=main_table.autor', array('autor' => 'prijmeni'));
