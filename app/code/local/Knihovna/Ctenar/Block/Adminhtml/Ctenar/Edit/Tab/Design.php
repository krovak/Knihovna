...
class Knihovna_Ctenar_Block_Adminhtml_Ctenar_Edit_Tab_Design
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('ctenar_');

        $model = Mage::registry('ctenar_page');

        $layoutFieldset = $form->addFieldset('layout_fieldset', array(
            'legend'   => Mage::helper('Ctenar')->__('Page Layout'),
            'class'    => 'fieldset-wide',
        ...
        $layoutFieldset->addField('root_template', 'select', array(
            'name'     => 'root_template',
            'label'    => Mage::helper('Ctenar')->__('Layout'),
            'required' => true,
        ...
        $layoutFieldset->addField('layout_update_xml', 'textarea', array(
            ...
            'label'    => Mage::helper('Ctenar')->__('Layout Update XML'),
            'style'    => 'height:24em;',
            'disabled' => $isElementDisabled
        ));

        $designFieldset = $form->addFieldset('design_fieldset', array(
            'legend'   => Mage::helper('Ctenar')->__('Custom Design'),
            'class'    => 'fieldset-wide',
            'disabled' => $isElementDisabled
        ));
        ...
        $designFieldset->addField('custom_theme_from', 'date', array(
            ...
            'label'    => Mage::helper('Ctenar')->__('Custom Design From'),
        ...
        $designFieldset->addField('custom_theme_to', 'date', array(
            ...
            'label'    => Mage::helper('Ctenar')->__('Custom Design To'),
            'image'    => $this->getSkinUrl('images/grid-cal.gif'),
            'format'   => $dateFormatIso,
            'disabled' => $isElementDisabled
        ));
        ...
        $designFieldset->addField('custom_theme', 'select', array(
            'name'     => 'custom_theme',
            'label'    => Mage::helper('Ctenar')->__('Custom Theme'),
        ...
        $designFieldset->addField('custom_root_template', 'select', array(
            ...
            'label'    => Mage::helper('Ctenar')->__('Custom Layout'),
        ...
        $designFieldset->addField('custom_layout_update_xml', 'textarea', array(
            ...
            'label'    => Mage::helper('Ctenar')->__('Custom Layout Update XML'),
            'style'    => 'height:24em;',
            'disabled' => $isElementDisabled
        ));

        Mage::dispatchEvent('adminhtml_ctenar_edit_tab_design_prepare_form', array('form' => $form));
