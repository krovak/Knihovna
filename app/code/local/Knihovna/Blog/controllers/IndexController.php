...
class Knihovna_Blog_IndexController extends Mage_Core_Controller_Front_Action
{
    public function indexAction()
    {
        /*
         * Create new blog post with author and title
         * -this will create new row in Knihovna_blog_post_entity table and
         *  two entries for title and author attributes will be saved in Knihovna_blog_post_entity_varchar table
         */
        $post = Mage::getModel('knihovna_blog/post');
         ...
         * -on new row will be added in Knihovna_blog_post_entity
         */
        $post = Mage::getModel('knihovna_blog/post');
         ...
         * -loaded data is only from Knihovna_blog_post_entity table
         */
        $posts = Mage::getModel('knihovna_blog/post')->getCollection();
        $posts->load();
        var_dump($posts);
         ...
         */
        $post = Mage::getModel('knihovna_blog/post')->load(1);
        var_dump($post);
    }
}